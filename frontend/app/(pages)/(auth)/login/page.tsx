          ...
          <div className="w-96 backdrop-blur-lg bg-opacity-80 rounded-lg shadow-lg p-5 bg-gray-900 text-white">
            ...
            <form>
              <div className="mb-4">
                ...
                <input type="email" id="email" className="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4" placeholder="andrew@mail.com"/>
              </div>
              <div className="mb-4">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm">
                  <p>New here?</p>
                  <Link href='/signup' className="underline cursor-pointer ml-1 hover:text-blue-500">Register</Link>
                </div>
              </div>
            </form>
          </div>
